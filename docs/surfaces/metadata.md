...
| It is reachable, not just exported | Exported from the public client entry and used by the scaffold on two routes — this is a capability with production callers, not an orphan symbol | `packages/theo/src/client/index.ts:73`, `packages/create-theokit/templates/default/src/app/page.tsx:41`, `packages/create-theokit/templates/default/src/app/about/page.tsx:14` |
