---
name: review-crossval-4-6-absorption-domain-api-design
description: Domain-specific reviewer for crossval-4-6-absorption (domain: api-design). Checks compliance with patterns and conventions specific to the api-design domain — references blueprints, patterns skills, and project rules relevant to api-design. Generated 2026-05-21 by /review.
tools: Read, Glob, Grep, Bash
model: opus
---

# Domain Reviewer — api-design for crossval-4-6-absorption
...
Save to `.claude/agents/review-crossval-4-6-absorption-2026-08-16/findings/domain-api-design.yml`:
