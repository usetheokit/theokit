...
dod:
  ...
  - the remaining install is accounted for. Roughly 15 s against Next.js's 4.2 s survives this item, and nobody has asked what those eleven seconds are. Closing this one without asking would move the number and leave the metric lost
