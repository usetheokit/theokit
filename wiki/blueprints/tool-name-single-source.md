---
type: Blueprint
title: Blueprint: tool-name contract at the agents/SDK boundary
description: Why a documented namespace path never worked, and where the naming rule has to live instead.
tags: [blueprint, tools, naming]
status: stable
generated: { by: process:deep-research, at: 2026-07-24T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: knowledge-base/discoveries/blueprints/tool-name-single-source-blueprint.md }
sources:
  - id: origin
    resource: knowledge-base/discoveries/blueprints/tool-name-single-source-blueprint.md
...
**Edge-case review:** `reviews/tool-name-single-source-edge-cases-2026-07-24.md`
**Date:** 2026-07-24
