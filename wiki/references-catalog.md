...
title: Peer reference catalog
description: The state-of-the-art peer projects gathered at project inception, and what each was studied for.
tags: [references, prior-art]
status: stable
generated: { by: process:roadmap-init, at: 2026-07-06T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: knowledge-base/references-catalog.md }
sources:
  - id: origin
    resource: knowledge-base/references-catalog.md
    title: Original document, absorbed into this bundle verbatim
    last_modified: 2026-07-06
# --- keys carried over from the source document ---
produced_by: roadmap-init
produced_on: 2026-07-03
...
catalog_location_note: >
  ...
  at references-catalog.md. The cloned peer folders themselves
...
# Status of the clones (2026-08-06)
...
What survives is this catalog — our own curated metadata about what was studied and why. The
cleanup protocol above is therefore historical. To study a peer again, re-clone it from the
repository URL listed in its row into a fresh read-only zone; the recorded commit SHA says
which revision the findings below were drawn from.

# Related
* [Grill: the AI-first roadmap](/grills/theokit-ai-first-roadmap.md) — the same `roadmap-init` run that curated these peers.
* [Blueprint: the injectable LoopStrategy seam](/blueprints/loop-strategy-seam.md) — one of the blueprints whose prior art came from these clones.
* [Blueprint: tool-name contract at the agents/SDK boundary](/blueprints/tool-name-single-source.md) — likewise sourced from the peer study.
