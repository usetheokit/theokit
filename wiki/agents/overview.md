...
type: Agent Guide
title: Agents
description: How an agent file in agents/ becomes a live HTTP endpoint, and the anatomy of an agent definition.
tags: [agents, guide, core]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-08-06T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: docs/agents/overview.md }
sources:
  - id: origin
    resource: docs/agents/overview.md
...
# Related
* [TheoKit terms](/glossary.md) — what the recurring vocabulary means.
