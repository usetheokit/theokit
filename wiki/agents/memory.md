...
type: Agent Guide
title: Agent memory
description: The two memory layers a TheoKit agent has, and when each one applies.
tags: [agents, memory, state]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-08-06T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: docs/agents/memory.md }
sources:
  - id: origin
    resource: docs/agents/memory.md
