...
description: Connecting an agent to external MCP tool servers without hand-writing the transport.
tags: [agents, mcp, tools]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-08-06T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: docs/agents/mcp.md }
sources:
  - id: origin
    resource: docs/agents/mcp.md
