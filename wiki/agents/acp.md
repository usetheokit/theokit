...
description: Giving an agent a coding agent — Claude Code, Amp, Codex — as a callable tool.
tags: [agents, acp, tools]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-07-07T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: docs/agents/acp.md }
sources:
  - id: origin
    resource: docs/agents/acp.md
