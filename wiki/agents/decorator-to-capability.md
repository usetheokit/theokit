---
type: Audit
title: Decorator to capability audit
description: Every exported agent decorator, what it contributed, and the capability that replaced it — the M53 hard gate.
...
`decisions/0002-decorator-removal-scope.md`.
