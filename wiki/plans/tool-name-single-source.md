---
type: Plan
title: Plan: single-source tool naming, and killing the dead HITL gate code
description: Making the tool-name rule exist in one place, applied where the name is minted, covering all three SDK rules.
tags: [plan, tools, naming]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-07-24T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: knowledge-base/plans/tool-name-single-source-plan.md }
sources:
  - id: origin
    resource: knowledge-base/plans/tool-name-single-source-plan.md
...
|---|---|---|
| Blueprint desta discovery | as 4 decisões (D1 cópia das 3 regras + gatilho; D2 uma derivação; D4 prova local; D5 recusa do VO) | `blueprints/tool-name-single-source.md` |
...
| Revisão de origem | os 6 achados que abriram o M55 | `grills/tool-name-single-source.md` § Q1 |
...
#### Evidence
`decisions/0001-capability-patterns-budget.md` — o precedente de formato (13 adotados / 8 recusados, cada um justificado).

#### Files to edit
- `decisions/0002-tool-name-single-source.md` (novo)
- `CHANGELOG.md`
...
#### Acceptance Criteria
- [ ] ADR contém as 5 decisões: `grep -c '^### D' decisions/0002-tool-name-single-source.md` retorna 5, e `grep -c 'Alternativas consideradas' ...` retorna 5
