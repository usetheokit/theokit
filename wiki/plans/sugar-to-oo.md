---
type: Plan
title: Plan: the free factory functions become classes
description: Converting the free factory functions into capability classes with zero behaviour change, deleting the functions in the same milestone.
tags: [plan, oo, api]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-07-24T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: knowledge-base/plans/sugar-to-oo-plan.md }
sources:
  - id: origin
    resource: knowledge-base/plans/sugar-to-oo-plan.md
...
| Fonte | Aporte | Onde |
|---|---|---|
| Blueprint da iniciativa | D1/Q6/Q7 — o design e a justificativa da reversão | `blueprints/layered-oo-boundary.md` |
...
| ADR-0001 | o patterns-budget revertido | `decisions/0001-capability-patterns-budget.md` |
...
#### Files to edit
- `decisions/0005-sugar-to-oo.md` (novo)
- changeset (major)
...
RED:     (documentação)
GREEN:   ADR + changeset
VERIFY:  grep -c "0001" decisions/0005-sugar-to-oo.md  → ≥ 1 (cita o ADR revertido)
```
...
#### Acceptance Criteria
- [ ] ADR cita o ADR-0001 e dá os 3 motivos: `grep -c '0001' decisions/0005-sugar-to-oo.md` ≥ 1 e o ADR lista 3 bullets de motivo
...
* [0006-configuration-error-unification](/decisions/0006-configuration-error-unification.md) — the error-unification decision.
