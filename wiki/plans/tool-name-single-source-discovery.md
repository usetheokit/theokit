---
type: Discovery Plan
title: Discovery plan: tool-name contract at the agents/SDK boundary
description: The research questions asked before designing the tool-name contract.
tags: [plan, discovery, tools]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-07-24T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: knowledge-base/discoveries/plans/tool-name-single-source-plan.md }
sources:
  - id: origin
    resource: knowledge-base/discoveries/plans/tool-name-single-source-plan.md
...
- [ ] `/discover-confidence` ≥ SHIPPABLE_WITH_CAVEATS
- [ ] Blueprint em `blueprints/tool-name-single-source.md`
