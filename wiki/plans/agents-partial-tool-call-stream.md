---
type: Plan
title: Plan: surface partial-tool-call as a typed stream event
description: Exposing the SDK's partial-tool-call lifecycle as a typed AgentStreamEvent for progressive tool input.
tags: [plan, streaming, tools]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-07-02T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: knowledge-base/plans/agents-partial-tool-call-stream-plan.md }
sources:
  - id: origin
    resource: knowledge-base/plans/agents-partial-tool-call-stream-plan.md
...
# Related
* [agents-partial-tool-call-stream-2026-07-02](/reviews/agents-partial-tool-call-stream-2026-07-02.md) — the merge review.
