---
type: Grill
title: Grill: the AI-first roadmap
description: The seven questions answered before the AI-first roadmap was written.
tags: [grill, roadmap, ai-first]
status: stable
generated: { by: process:roadmap-init, at: 2026-07-03T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: knowledge-base/grills/theokit-ai-first-roadmap-grill.md }
sources:
  - id: origin
    resource: knowledge-base/grills/theokit-ai-first-roadmap-grill.md
...
# Related
* [Peer reference catalog](/references-catalog.md) — the peer projects this same run curated.
...
* [0.13-to-0.14-agent-surface](/migration/0.13-to-0.14-agent-surface.md) — the migration guide it produced.
