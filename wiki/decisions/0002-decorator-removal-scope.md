---
type: ADR
title: ADR 0002: what happens to each agent decorator when the surface is deleted
description: Per-decorator disposition for the M53 removal, the hard gate being a decorator with no capability equivalent.
tags: [adr, decorators, capability]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-07-23T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: knowledge-base/adrs/0002-decorator-removal-scope.md }
sources:
  - id: origin
    resource: knowledge-base/adrs/0002-decorator-removal-scope.md
...
- **Depends on:** [ADR 0001](0001-capability-patterns-budget.md) (the capability layer), the audit at
  `agents/decorator-to-capability.md`
