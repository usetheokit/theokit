---
type: Guide
title: Three ways to define an agent
description: The three authoring surfaces that compile to one runtime, and when to reach for each.
tags: [guide, agents, authoring]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-07-24T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: docs/guides/agent-surfaces.md }
sources:
  - id: origin
    resource: docs/guides/agent-surfaces.md
...
> `@theokit/agents` v1.0 (M53). Veja `MIGRATION.md`, at the repository root.
