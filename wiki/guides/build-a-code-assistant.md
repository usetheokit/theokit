---
type: Guide
title: Build a code assistant, end to end
description: A full walkthrough from empty directory to a working code-assistant chat app.
tags: [guide, tutorial, agents]
status: stable
generated: { by: theokit-agent/unrecorded, at: 2026-07-24T00:00:00Z }
migrated: { by: claude-opus-5/okf-skill, at: 2026-08-06T00:00:00Z, from: docs/guides/build-a-code-assistant.md }
sources:
  - id: origin
    resource: docs/guides/build-a-code-assistant.md
