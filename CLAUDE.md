...
- `npm create theokit my-app` → chat thread (rendered with `@theokit/ui` components) live in <30 seconds
...
1. Every TheoKit deliverable wires `@theokit/ui` (UI surface) + `@usetheo/sdk` (agent runtime). Premise. Sugar over the SDK, not parallel implementations.
