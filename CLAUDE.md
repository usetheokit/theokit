...
**Only the TheoCloud-side copy exists today** — the TheoKit-side mirror at `docs/architecture/theokit-theocloud-integration.md` is **absent** (verified 2026-08-06). Until it is restored, read the TheoCloud copy; when it is restored, keep both in sync (edit one, copy the diff to the other in the same commit).
